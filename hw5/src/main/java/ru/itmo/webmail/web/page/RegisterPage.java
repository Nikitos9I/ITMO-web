...
public class RegisterPage extends Page {
    private void register(HttpServletRequest request, Map<String, Object> view) {
        ...
        request.getSession(true).setAttribute("registeredUserId", user.getId());
        getEmailConfirmationService().save(user.getId(), getEmailConfirmationService().getStringSha(user.getLogin()));
