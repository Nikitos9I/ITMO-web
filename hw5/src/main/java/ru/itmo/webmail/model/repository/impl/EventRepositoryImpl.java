...
public class EventRepositoryImpl extends GeneralRepositoryImpl<Event> implements EventRepository {
    ...
    @Override
    public Event toInstance(ResultSetMetaData metaData, ResultSet resultSet) throws SQLException {
        return null;
    }
